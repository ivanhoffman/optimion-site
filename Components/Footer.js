...
function PhoneIcon({ className = "w-4 h-4" }) {
  return (
    <svg viewBox="0 0 24 24" className={className} aria-hidden="true" fill="none">
      <path
        d="M5 4a2 2 0 0 1 2-2h1.2a1 1 0 0 1 .95.68l1.1 3.28a1 1 0 0 1-.26 1.04l-1.2 1.2a12.5 12.5 0 0 0 6.01 6.01l1.2-1.2a1 1 0 0 1 1.04-.26l3.28 1.1a1 1 0 0 1 .68.95V19a2 2 0 0 1-2 2h-1C10.61 21 3 13.39 3 4.99V4Z"
        stroke="currentColor"
        strokeWidth="1.5"
        strokeLinecap="round"
